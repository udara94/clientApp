package com.example.clientapp.common.constants;

public interface ApplicationConstants {
    String MY_NAME_IS_UDARA = "MY_NAME_IS_UDARA";
    String ERROR_MSG_TOKEN_EXPIRED = "The resource owner or authorization server denied the request.";
    String ERROR_MSG_REST_UNEXPECTED = "An error occured. Please try again later.";
    ...
    String FONT_ACUMIN_PRO_BOLD = "Acumin-Pro-Bold";

    String FONT_ACUMIN_PRO_SEMIBOLD = "Acumin-Pro-Semibold";

    String FONT_ACUMIN_PRO_REGULAR = "Acumin-Pro-Regular";

    String FONT_ROBOTO_BOLD = "Roboto-Bold";
